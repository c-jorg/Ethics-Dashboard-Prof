...
def test_add_class_success(client, student_fixture):
    ...
    assert 'message' in response.json == {"message":"Class and students created successfully"}

def test_add_class_existing(client, student_fixture):
    """
    Given POST /api/add-class
    ...
    assert 'message' in response.json == {"message":"Class with this class code already exists"}
...
def test_add_class_no_prof_id(client, student_fixture):
    ...
    student_list, student_list_full = student_fixture
    response = client.post('/api/add-class', 
            data = json.dumps({"class_name":"class 4", "class_code":"class4", "students":student_list}),
            headers = {'Content-Type': 'application/json'})
...
def test_add_class_no_class_code(client, student_fixture):
    ...
    student_list, student_list_full = student_fixture
    response = client.post('/api/add-class', 
            data = json.dumps({"class_name":"class 4", "professor_id":2, "students":student_list}),
            headers = {'Content-Type': 'application/json'})
...
def test_add_class_type_error(client, student_fixture):
    ...
    student_list, student_list_full = student_fixture
    response = client.post('/api/add-class', 
            data = json.dumps({"class_name":"class 4", "professor_id":"2", "class_code":4, "students":student_list}),
            headers = {'Content-Type': 'application/json'})
...
def test_add_class_no_student_email(client, student_fixture):
    """
    Given POST /api/add-class
    ...
    #student_list, student_list_full = student_fixture
    response = client.post('/api/add-class',
            data = json.dumps({"class_name":"class 4", "professor_id":2, "class_code":"class4", "students":[{"name":"student1"},{"name":"student2"}]}),
            headers = {'Content-Type': 'application/json'})
    print(response.data)
    assert response.status_code == 400
    assert 'message' in response.json == {"message":"Missing student name or email"}
    
def test_add_class_some_correct_students(client, student_fixture):
    """
    Given POST /api/add-class
    ...
    student_list, student_list_full = student_fixture
    response = client.post('/api/add-class',
            data = json.dumps({"class_name":"class 4", "professor_id":2, "class_code":"class4", "students":[{student_list[0]},{"name":"student2"},{"email":"student3@mail.com"}]}),
            headers = {'Content-Type': 'application/json'})
    print(response.data)
    assert response.status_code == 400
    assert 'message' in response.json == {"message":"Missing student name or email"}
...
def test_add_class_existing_student(client, student_fixture):
    ...
    response = client.post('/api/add-class',
            data = json.dumps({"class_name":"class 4", "professor_id":2, "class_code":"class4", "students":[student_list[0]]}),
            headers = {'Content-Type': 'application/json'})
    print(response.data)
    assert response.status_code == 201
    assert 'message' in response.json == {"message":"Class and students created successfully"}
...
def test_add_class_some_existing_students(client, student_fixture):
    ...
    student_list, student_list_full = student_fixture
    response = client.post('/api/add-class',
            data = json.dumps({"class_name":"class 4", "professor_id":2, "class_code":"class4", "students":student_list_full}),
            headers = {'Content-Type': 'application/json'})
    print(response.data)
    assert response.status_code == 201
    assert 'message' in response.json == {"message":"Class and students created succefully"}
...
def test_add_class_existing_enrollment(client, student_fixture):
    ...
    student_list, student_list_full = student_fixture
    response = client.post('/api/add-class',
            data = json.dumps({"class_name":"class 4", "professor_id":2, "class_code":"class4", "students":[student_list_full[3]]}),
            headers = {'Content-Type': 'application/json'})
    print(response.data)
    assert response.status_code == 201
    assert 'message' in response.json == {"message":"Class and students created successfully"}
...
def test_get_class_by_id_success(client, professor_class_ta_fixture):
    ...
    assert 'prof_id' in response.json
