...
class Submission(db.Model):
    ...
    def get_submissions_by_assignment_id_form_id_and_student_id(cls, assignment_id, form_id, student_id):
        return db.session.query(cls).filter(cls.assignment_id == assignment_id, cls.form_id == form_id,
    ...
    def delete_submissions_by_assignment_id_form_id_and_student_id(cls, assignment_id, form_id, student_id):
        db.session.query(cls).filter(cls.assignment_id == assignment_id, cls.form_id == form_id,
                                     cls.student_id == student_id).delete()
        db.session.commit()
