...
class Grade(db.Model):
    ...
    assignment_id = db.Column("assignment_id", db.Integer, db.ForeignKey(
        'assignments.assignment_id'))  # Assignment has student id so dont need that in this table
    ...
    def get_grade_by_form_group_and_assignment_id(cls, form_group, assignment_id):
        print("GRADE MODEL: get grade by form group called with form group " + form_group + " and assignment id " + str(
            assignment_id))
