...
class Assignment(db.Model):
    ...
    case_study_option_id = db.Column("case_study_option_id", db.Integer,
                                     db.ForeignKey("case_study_options.case_study_option_id"), nullable=True)
    ...
    def __init__(self, student_id, case_study_id, case_study_options_id, submitted, graded, last_modified):
        self.student_id = student_id
        self.case_study_id = case_study_id
        self.case_study_options_id = case_study_options_id
    ...
    def json(self):
        return {
            ...
            'case_study_options_id': self.case_study_options_id,
