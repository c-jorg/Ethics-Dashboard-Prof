...
class Feedback(db.Model):
    ...
    answer_id = db.Column("answer_id", db.Integer, db.ForeignKey(
        'answers.answer_id'))  # for feedback associated with a single answer (only answer id populated)
    form_id = db.Column("form_id", db.Integer, db.ForeignKey(
        'forms.form_id'))  # for feedback associated with a whole form (only form id populated)
    section_key = db.Column("section_key",
                            db.String)  # for feedback associated with a section of a form (form id and section key populated)
